  ...
  <section>
    <form method="post" action="<?= h(url('technology-save')) ?>" enctype="multipart/form-data" class="stack">
      ...
      <label>Стоимость
        ...
        <span class="hint">Пусто — стоимость рассчитывается по столбцу: внутри эпохи
          следующий столбец дороже предыдущего на коэффициент столбца, на границе эпохи —
          на коэффициент эпохи. Заданное здесь число сильнее расчётного и показывается
          на всех досках.</span>
      </label>
